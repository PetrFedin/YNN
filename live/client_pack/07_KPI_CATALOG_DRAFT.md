...
## E. Привязка к файлам (evidence)

| KPI | Файл / mart |
|-----|-------------|
| K01–K02 | `live/marts/recon_md_payments_vs_dds_adj.csv`, `MD_CHANNEL.md` |
| K03 | `live/marts/margin_channel_month.csv`, `margin_channel_total.csv` |
| K04 | `live/marts/margin_channel_views_h28.csv`, `TSUM_COGS_SPLIT.md` |
| K05 | `live/marts/release_gate_month.csv`, `RELEASE_GATE.md` |
| K06 | `live/marts/data_request_b2b_open.csv` |
| K07 | `live/marts/recon_im_combo.csv` |
| K08–K09 | `live/marts/controls_summary.csv`, `recon_payroll_multi.csv` |
| K10 | `08_POLICY_DRAFTS.md` P-A |
| Детализация | `11_FULL_ANALYTICAL_DETAIL.md` |
